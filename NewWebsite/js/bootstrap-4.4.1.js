...
var i = 0;
var txt = 'Piotrek4 - Unity Game Developer';
var speed = 285;
										
//endanimation
var i2 = 0;
var txt2 = 'hayoo! you reached the end of my website :3';
var speed2 = 100;
...
function typeWriter2() {
  if (i2 < txt2.length) {
    document.getElementById("endtext").innerHTML += txt2.charAt(i);
    i2++;
...
$(document).ready(function(){
    var toggleReadMore = function() {
      $('#read-more').click(function(e) {
          $(this).prev().animate({'height': $(this).prev()[0].scrollHeight + 'px'}, 800);
          $(this).hide();
      ...
      $('#read-less').click(function(e) {
          ...
          $(this).prev().prev().animate({height: '60px'}, 2200);
          $(this).hide();
...
$(document).ready(function(){
    var toggleReadMore2 = function() {
      $('#read-more2').click(function(e) {
          $(this).prev().animate({'height': $(this).prev()[0].scrollHeight + 'px'}, 800);
          $(this).hide();
          $(this).next('#read-less2').show();
		  
      });
      $('#read-less2').click(function(e) {
		  
          $(this).prev().prev().animate({height: '45px'}, 2200);
          $(this).hide();
          $(this).prev('#read-more2').show();
      });
...
$(".sidebar-box .expander").click(function() {
...
$(document).ready(function(){
    var toggleReadMore = function() {
      ...
      $('#read-less').click(function(e) {
          $(this).prev().prev().animate({height: $(this).prev()[0].scrollHeight + 'px'}, 800);
          $(this).hide();
          $(this).prev('#read-more').show();
      });
...
$("ssbtn").onclick = function(){
	scrollTo('work', 2500, {easing:'elasout'});
}

const APIKey = 'AIzaSyDDIwR1v3z2SYnODPWf0kSvSYWJWiZRJlg';
